 ...
 *
 * É configuração, não fila de trabalho: aparece nos DOIS módulos do AURA, com
 * uma rota em cada um (o path é o que define o módulo no sidebar). O que cada
 * destino implica em termos de módulo está em [[crm-modulo]].
 */
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            O destino também decide o módulo: <strong>adesão</strong> e{" "}
            <strong>usina + UC</strong> vão para a Associação de Energia;{" "}
            <strong>obra</strong> e <strong>plano de monitoramento</strong> vão para a
            Brasil Solar. Mudar aqui move a venda de fila na hora, sem re-sincronizar.
          </p>
        </div>
      </div>
