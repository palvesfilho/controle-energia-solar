 ...
 * A senha NÃO viaja no GET normal de credenciais: quem abre a tela da usina não
...
export async function GET(
  ...
  console.log(
    `[credenciais] senha da usina ${id} revelada por ${session.user.email ?? session.user.id}`
  );
